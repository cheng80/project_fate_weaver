...
- `tests/test_gameplay_run_split_events.py`
- `tests/test_gameplay_run_category_bulk_fill.py`
...
- `tests.test_gameplay_run_split_events.GameplayP0SplitEventTests.test_duplicate_event_id_raises_clear_error`
...
```bash
PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=src .venv/bin/python -m unittest tests.test_gameplay_run_split_events
```
...
```bash
PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=src .venv/bin/python -m unittest tests.test_gameplay_run_split_events tests.test_gameplay_run_category_bulk_fill
```
